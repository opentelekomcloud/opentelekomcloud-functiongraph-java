...
/*
 * Example of FuctionGraph on how to restart ECS instances
 * 
 ...
 * - STOP_TYPE stop type "HARD" or "SOFT"
 *  
 * see: https://docs.otc.t-systems.com/elastic-cloud-server/api-ref/apis_recommended/batch_operations/restarting_ecss_in_a_batch.html
 *  
 */
...
/**
 * Restart ECS Instance(s)) example.
 */
public class RestartECSInstance {
  ...
  public String handleRequest(final JsonObject event, final Context context) {
    ...
    try {
      ...
      String body = String.format("{\"reboot\":{\"servers\":[%s],\"type\": \"%s\"}}", getServerIds(instanceId),
          stopType);

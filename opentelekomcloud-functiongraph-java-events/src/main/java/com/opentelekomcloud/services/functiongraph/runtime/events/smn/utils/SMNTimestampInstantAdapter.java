...
package com.opentelekomcloud.services.functiongraph.runtime.events.smn.utils;
 ...
 */
public class SMNTimestampInstantAdapter implements JsonSerializer<Instant>, JsonDeserializer<Instant> {

  private static final String INPUT_DATE_TIME_PATTERN = "EEE MMM dd yyyy HH:mm:ss 'GMT'Z '('z')'";
  private static final String OUTPUT_DATE_TIME_PATTERN = "yyyy-MM-dd'T'HH:mm:ss'Z'";

  private static final DateTimeFormatter inputFormatter = DateTimeFormatter.ofPattern(INPUT_DATE_TIME_PATTERN);
  private static final DateTimeFormatter outputFormatter = DateTimeFormatter.ofPattern(OUTPUT_DATE_TIME_PATTERN);
  ...
  public Instant deserialize(JsonElement jsonElement,
    ...
    return ZonedDateTime.parse(jsonElement.getAsString(), inputFormatter).toInstant();
  }
}

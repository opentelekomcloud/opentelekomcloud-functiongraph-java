 ...
 * SMN Event Record and parses them back.
 */
public class SMNRecordTimestampInstantAdapter implements JsonSerializer<Instant>, JsonDeserializer<Instant> {

  // pattern used in SMN Event Record
